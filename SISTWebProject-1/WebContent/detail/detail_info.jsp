            ...
            <div class="col-lg-6 col-md-6">
                ...
                <div class="content_summary">
                  <ul>
                    ...
                    <li>
                      <a href="#">리뷰 작성 ID</a>
                      <span>리뷰 평점 (그리기 javascript)</span>
                    </li>  
                  </ul>
            ...
            <div class="col-lg-2 col-md-2">
              ...
              <div class="col-lg-5 col-md-5">
                <div class="single-post-item short">
                  ...
                  <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=68cba5ac8135df1b2685073fb0fd9f93"></script>
                  <script>
