...
<div class="container-fluid bg-3 text-center">
	...
	<div class="row">
		<div class="col-sm-3" style="cursor: pointer;"
			onclick="../category/tourplacetag_content.do">
			<div class="cate-img">
		...
		<c:forEach var="vo" items="${list }">
			<div class="col-lg-3 col-md-3">
				<div class="single-post-item short">
					<figure> <a href="tourplacetag_content.do"><img
						class="post-img img-fluid" src="${vo.tphoto }"
						alt=""></a> </figure>
					<div class="heart">
					...
					<div class="detail_food3">
						<h4>
							<a href="blog-details.html">${vo.tname }</a>
						</h4>
						<div class="grade">
	...
	<ul class="pagination">
		...
		<c:if test="${startPage>1 }">
			<li class="page-item"><a
				href="../category/tourplace.do?page=${startPage-1}" class="page-link"
